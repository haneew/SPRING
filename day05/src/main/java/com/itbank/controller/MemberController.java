...
@Controller
@RequestMapping("/member")		// 컨트롤러에도 맵핑을 사용할 수 있다!! (계층형)
public class MemberController {
	...
	public ModelAndView memberList() {	
		...
		// 요청 주소를 구성하는 문자열을 viewName을 활용한다
	...
	public String delete(@PathVariable("idx") int idx) {
		...
		System.out.println(row != 0 ? "삭세 성공" : "삭제 실패");
	...
	public String modify(MemberDTO dto) {	// 수정의 GETMapping이 PathVariable이므로 동일하게 써야하지만! MemberDTO로 넘겨준다
