...
public class LoginInterceptor implements HandlerInterceptor {
	...
	// 1. preHandle : 요청이 컨트롤러 함수(Handle)에 도달하기 전에 작동한다
	// 2. postHandle : 컨트롤러 함수(Handler)가 실행된 이후 view(JSP)로 넘어가기 전에 작동한다
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
		...
		String url = request.getRequestURL().toString();	// 로그인 후 원래 가려던 페이지로 이동하기 위해서
