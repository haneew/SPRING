...
<ul>
	...
	<li><a href="ex04">ex04 - ajax(List&ltDTO>반환)</a></li>
</ul>
...
<script>
	...
	const param = {
			serviceKey: 'tOclLGCPWxIkCEFzsT9%2F%2F9WEUzFMvWgFPGHefY99sOqsIf7iTzQiOULNUeiKEpARkSc9V4tsIo5QCmjqpLk5GA%3D%3D',
			pageNo: '1',
			numOfRows: '25',
			resultType: 'json',
	}
